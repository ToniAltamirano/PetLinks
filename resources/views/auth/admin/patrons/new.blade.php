        ...
        @csrf
            <div class="form-row">
                <div class="form-group col">
                    ...
                    <input type="text" class="form-control" id="inputNombre" name="nombre" placeholder="{{ __('admin/macropadrins.name_placeholder') }}" value="{{ old('nombre') }}">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col">
                    <label for="inputNombre">{{ __('admin/macropadrins.url') }}:</label>
                    <input type="text" class="form-control" id="inputNombre" name="url" placeholder="{{ __('admin/macropadrins.url_placeholder') }}" value="{{ old('url') }}">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col">
