        ...
        @csrf
            <div class="form-row">
                <div class="form-group col">
                    ...
                    <input type="text" class="form-control" id="inputNombre" name="nombre" placeholder="{{ __('admin/macropadrins.name_placeholder') }}" value="{{ old('nombre') }}" required>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col">
                    <label for="inputNombre">{{ __('admin/macropadrins.url') }} *</label>
                    <input type="text" class="form-control" id="inputNombre" name="url" placeholder="{{ __('admin/macropadrins.url_placeholder') }}" value="{{ old('url') }}" required>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col">
            ...
            <div class="col-12 m-0 p-0 mt-2 mb-1">
                ...
                <button type="submit" class="btn btn-primary">{{ __('admin/macropadrins.add_btn') }}</button>
            </div>
