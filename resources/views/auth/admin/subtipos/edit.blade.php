        ...
        <form class="" action="{{ action('SubtipoController@update', [$subtipos->id]) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" id="inputNombre" value="{{ $subtipos->nombre }}" name="nombre" placeholder="Nombre subtipo">
                </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" id="tipoUnidad" value="{{ $subtipos->tipo_unidad }}" name="tipoUnidad" placeholder="Tipo unidad">
                </div>    
            </div>   
